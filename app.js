// Festival Pocket loader: force full light appearance + core app + additional festival dataset
(function(){
  ...
  style.textContent=`
    ...
    .summary,.pill,.search,.icon-btn,.mini-event,.pref-card,.month-card,.map-shell,.card,.empty,.selection-sheet,.map-info,.map-title,.map-tools button{background:#fff !important;color:#121212 !important;border-color:rgba(17,17,17,.08) !important;}
    .rec-card{background:#fff !important;color:#121212 !important;border-color:rgba(17,17,17,.07) !important;}
    ...
    .badge.blue,.badge.green,.badge.orange{background:#efefed !important;color:#555 !important;}
    ...
    .cover .heart{background:#fff !important;color:#6f6f6c !important;}
    .cover .heart.on{background:#111 !important;color:#fff !important;}
    ...
    .warnbox{background:#fff2f3 !important;color:#92424b !important;border-color:rgba(17,17,17,.05) !important;}
    .parking{background:#f7f7f9 !important;color:#5e5e64 !important;}
    .map-panel{background:#f0f1ef !important;border-color:rgba(17,17,17,.06) !important;}
    .land{fill:#e3e5e2 !important;stroke:#a8aba6 !important;}
    .road{stroke:#d2d4d0 !important;}.river{stroke:#b8c5cf !important;}.label{fill:#777b76 !important;}
    ...
    .selection-sheet{border-top:1px solid rgba(17,17,17,.08) !important;}
    .sheet-head{border-bottom-color:rgba(17,17,17,.08) !important;}.sheet-handle{background:#d0d0cf !important;}
    .pick-row{border-bottom-color:rgba(17,17,17,.07) !important;}.pick-check{background:#fff !important;border-color:#bbb !important;}.pick-check:checked{background:#111 !important;border-color:#111 !important;}.pick-check:checked::after{border-color:#fff !important;}.pick-score{color:#666 !important;}
    .bottom-nav{background:rgba(255,255,255,.92) !important;border-color:rgba(255,255,255,.98) !important;box-shadow:0 12px 38px rgba(0,0,0,.14) !important;}
    .bottom-nav button{background:transparent !important;color:#8e8e93 !important;}
    input,select,textarea,button{color-scheme:light !important;}
  `;
  document.head.appendChild(style);

  const core=document.createElement('script');
  core.src='app-core.js?v=20260825-light1';
  core.onload=function(){
    const extra=document.createElement('script');
    extra.src='festival-extra.js?v=20260825-light1';
